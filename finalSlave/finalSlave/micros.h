...
/*************************************************************
	USER SETUP SECTION
**************************************************************/
#define MICROS_RESOLUTION				100 // time interval after the interrupt will trigger in microseconds
...
#define MICROS_TIMER 		MICROS_TIMER0 // which timer to use
...
void micros_init(void){
	...
	REG_OCR = ((F_CPU / PRESCALER) / (1000000 / MICROS_RESOLUTION)) - 1; // (1000000 / resolution_us) is the frequency
	sei();
}
